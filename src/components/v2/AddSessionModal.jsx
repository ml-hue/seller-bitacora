 ...
 * Integrado con Claude API para generar resumen automático
 */
const AddSessionModal = ({ projectId, onClose, onSuccess }) => {
  ...
  const generateResumenWithClaude = async () => {
    ...
    try {
      ...
      if (result.success) {
        // El resumen viene en result.summary como texto en markdown
        const resumenTexto = result.summary;
        
        // Actualizar el campo de contenido con el resumen generado
        setFormData(prev => ({
          ...prev,
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200 sticky top-0 bg-white">
          <h2 className="text-xl font-bold text-gray-900">Nueva Sesión</h2>
          <button
            onClick={onClose}
          ...
          <div>
            <div className="flex items-center justify-between mb-1">
              ...
              >
                ...
                <span>{generatingResumen ? 'Generando...' : 'Generar resumen con IA'}</span>
              </button>
            </div>
            <textarea
            ...
            <p className="text-xs text-gray-500 mt-1">
              💡 Escribe los detalles de la sesión y luego podrás generar un resumen ejecutivo automático
            </p>
          </div>
